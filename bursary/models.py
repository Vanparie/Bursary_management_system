...
class Student(models.Model):
    ...
    site_profile = models.ForeignKey(
        "bursary.SiteProfile", on_delete=models.SET_NULL, null=True, blank=True, related_name="students"
    )
...
class OfficerProfile(models.Model):
    ...
    site_profile = models.ForeignKey(
        "bursary.SiteProfile", on_delete=models.SET_NULL, null=True, blank=True, related_name="officers"
    )
